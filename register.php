...
if (isset($_POST['register'])) {
    ...
    if(count($errors)==0){
        $sql = "INSERT INTO user_list(username, name, contact, email, pass, age, blood_group, NID, gender, police_station, city) VALUES('$username', '$name', '$contact', '$email', '$pass', '$age', '$blood_group', '$nid', '$gender', '$police_station', '$city')";
